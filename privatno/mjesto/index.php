		...
		<div class="row">
			...
			<div class="col-sm-9 padding-right">
				<div class="features_items"><!--features_items-->
					<h2 class="title text-center">Mjesto</h2>

					<?php 

					$poStranici=40;
					
					$izraz = $veza -> prepare("select count(id) from mjesto");
					$izraz -> execute();
					...
					$izraz = $veza -> prepare("
						select * from mjesto limit :odKuda, :poStranici;
					...
					<table  style="width:95%; ">
						<tbody>
							...
							<br>
							<?php foreach ($niz as $mjesto): ?>
								

								<tr ">
									<td><?php echo $mjesto -> id; ?></td>
									<td><?php echo $mjesto -> naselje; ?></td>
									<td><?php echo $mjesto -> postanskibroj; ?></td>
									<td><?php echo $mjesto -> opcina; ?></td>		
									<td><?php echo $mjesto -> zupanija; ?></td>
									<td>
